...
var UserTempService = /** @class */ (function () {
    function UserTempService(http) {
        this.http = http;
    }
    UserTempService.prototype.getAll = function () {
        return this.http.get('/api/userapi');
    };
    UserTempService.prototype.getById = function (id) {
        return this.http.get('/api/userapi/' + id);
    };
    UserTempService.prototype.create = function (user) {
    ...
    UserTempService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], UserTempService);
    return UserTempService;
}());
exports.UserTempService = UserTempService;
//# sourceMappingURL=usertemp.service.js.map